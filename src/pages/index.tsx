...
export default function Home() {
  return (
    <div>
      ...
      <div className="bg-yellow-200 grid lg:grid-cols-2 2xl:grid-cols-5 h-full">
        ...
        <div className="hidden relative h-full lg:block 2xl:col-span-3">
          <img
